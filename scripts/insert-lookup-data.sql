-- ============================================
-- MANUAL SCRIPT: INSERT LOOKUP DATA
...
-- Verification
SELECT 'Company Domains:' as table_name, COUNT(*) as count FROM company_domain WHERE is_deleted = false
UNION ALL
SELECT 'Job Levels:', COUNT(*) FROM job_level WHERE is_deleted = false
UNION ALL
SELECT 'Work Types:', COUNT(*) FROM work_type WHERE is_deleted = false
UNION ALL
